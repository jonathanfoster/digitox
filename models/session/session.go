...
type Session struct {
	...
	Blocklists     []*blocklist.Blocklist `json:"blocklists" valid:"required" gorm:"many2many:session_blocklists;association_autoupdate:false;association_autocreate:false"`
